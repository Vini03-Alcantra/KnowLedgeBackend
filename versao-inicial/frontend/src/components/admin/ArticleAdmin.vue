    ...
    <div class="article-admin">
        <b-form>
            <input v-model="article.id" type="hidden" id="article-id">
                ...
                <b-form-group label="Título" id="article-name" label-form="article-name">
                ...
                <b-form-group id="article-description" label="Descrição" label-form="article-description">
                ...
                <b-form-group v-if="mode === 'save'" label="Autor: " label-for="article-userId">                    
                    <b-form-select id="article-useryId" :options="users" v-model="article.userId"></b-form-select>
                </b-form-group>                

                <b-form-group v-if="mode === 'save'" label="Conteúdo" label-form="category-content">
                    <VueEditor v-model="article.content" placeholder="Informe o conteúdo do Artigo" />
                </b-form-group>                

                <b-button variant="primary" v-if="mode === 'save'" @click="save">Salvar</b-button>
                <b-button variant="danger" v-if="mode === 'remove'" @click="remove">Excluir</b-button>
                <b-button variant="ml-2" @click="reset">Cancelar</b-button>
...
export default{
    ...
    methods: {
        ...
        save(){
            ...
            const id = this.article.id ? `/articles/${this.article.id}` : '/articles'
            axios[method](`${baseApiUrl}${id}`, this.article)
                .then(() => {
